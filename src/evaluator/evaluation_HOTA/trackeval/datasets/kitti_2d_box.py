...
class Kitti2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': os.path.join('src/evaluator/evaluation/data/tracking'),  # Location of GT data
            'TRACKERS_FOLDER': os.path.join('src/evaluator/evaluation/results'),  # Trackers location
