...
class TrackMAP(_BaseMetric):
    ...
    def get_default_metric_config():
        ...
        default_config = {
            'USE_AREA_RANGES': False,  # whether to evaluate for certain area ranges
            ...
            'USE_TIME_RANGES': False,  # whether to evaluate for certain time ranges (length of tracks)
    ...
    def eval_sequence(self, data):
        ...
        print(data.keys())
        gt_ids, dt_ids = data['gt_ids'], data['tracker_ids']
        ...
        ious = self._compute_track_ious(data['gt_dets'], data['tracker_dets'],
                                        boxformat=boxformat)
